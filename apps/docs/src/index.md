...
#     details: Optional packages for RabbitMQ, Redis, Postgres, MySQL, MongoDB, SQLite, DynamoDB, Drizzle ORM, Prisma, Elasticsearch, and S3 wire common clients into checks with minimal configuration.
---
