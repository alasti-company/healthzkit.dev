...
#     details: Optional packages for RabbitMQ, Redis, Valkey, Postgres, MySQL, MongoDB, SQLite, DynamoDB, Drizzle ORM, Prisma, Elasticsearch, HTTP endpoints, S3, and MinIO wire common clients into checks with minimal configuration.
---
